 ...
 *
 * 아이콘 라이브러리를 넣지 않는 이유: 탭 다섯 개에 쓰자고 의존성을 하나 더 늘릴 이유가 없고,
 ...
 * 하객 — 사람 둘.
 *
 * 앞사람은 머리(원)와 어깨선을 온전히 그리고, 뒷사람은 오른쪽 반쪽만 그린다.
 * 23px 로 축소되면 두 사람을 나란히 그렸을 때 서로 붙어 덩어리로 뭉개지는데,
 * 겹쳐 세우면 실루엣이 '여럿'으로 읽힌다.
 */
export const GuestsIcon = (props: IconProps) => (
  <Frame {...props}>
    <circle cx="9.1" cy="7.6" r="3.7" />
    <path d="M15.3 20.4v-1.6a3.8 3.8 0 0 0-3.8-3.8H6.7a3.8 3.8 0 0 0-3.8 3.8v1.6" />
    <path d="M15.4 4.1a3.7 3.7 0 0 1 0 7" />
    <path d="M21.1 20.4v-1.6a3.8 3.8 0 0 0-2.9-3.7" />
  </Frame>
)
